...
export const buildTag = "i18n-refresh-20260326-3";
...
zh: {
  ...
  languageZhLabel: "中",
  feedEyebrow: "私人档案",
  feedTitle: "用文字、图片和小小仪式感，丰富你的记录空间。",
  signedInAs: (name) => `当前登录：${name}`,
  joinPrompt: "注册后即可发布内容，并建立属于自己的档案。",
  loadingPosts: "正在加载动态...",
  feedUnavailable: "当前无法获取动态。",
  noPostsEyebrow: "还没有内容",
  noPostsTitle: "从第一条记录开始，建立你的档案。",
  noPostsBody: "使用“发布”写下一段想法、一幕场景，或上传一组图片。",
  postMediaAlt: "帖子图片",
  loginEyebrow: "登录",
  loginTitle: "回到你的档案。",
  loginHint: "登录账号后，可以在不同设备间继续发布内容。",
  signingIn: "登录中...",
  loginFailed: "登录失败",
  working: "处理中",
  email: "邮箱",
  ...
  loginButton: "登录",
  registerEyebrow: "注册",
  registerTitle: "开启一个安静的发布账号。",
  registerHint: "创建个人资料后，即可开始发布内容。",
  ...
  goToLogin: "前往登录",
  text: "文字",
  textPlaceholder: "写点简短的、私人的，或带画面感的内容。",
  addImages: "添加图片",
  publish: "发布",
  ...
  publishComment: "发表评论",
  sendingComment: "发布中...",
  commentPlaceholder: "写一点友善、简短或有帮助的话吧。",
  signInToComment: "登录后才可评论。",
  noComments: "还没有评论。",
  loadingComments: "正在加载评论...",
  likeFailed: "点赞失败",
  commentFailed: "评论发布失败",
  commentsLoadFailed: "评论加载失败",
  authRequiredAction: "登录后即可互动",
},
};
